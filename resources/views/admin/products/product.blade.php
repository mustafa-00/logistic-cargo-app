                    ...
                    <div class="card-body pt-3">
                        <ul class="nav nav-tabs nav-tabs-bordered">
                            ...
                            <li class="nav-item col-4">
                                <a href="{{ route('product.create') }}" class="nav-link"><button class="btn btn-primary">Add New Product</button></a>
                            </li>
                        </ul>
                                            ...
                                            <tbody>
                                                @foreach ($products as $item)
                                                    <tr>
                                                        ...
                                                        <a href="{{ route('product.show', $item->id) }}" title="View"><i class="bx bx-show-alt me-1" style="font-size: 20px"></i></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
